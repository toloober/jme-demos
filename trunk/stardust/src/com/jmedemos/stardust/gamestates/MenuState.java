...
import com.jmedemos.stardust.util.FengJMEInputHandler;
...
/**
 * The Menu Gamestate.
 * creates a Menu with the FengGUI library.
 */
    ...
    private void createSettingsFrame() {
        ...
        GameTaskQueueManager.getManager().render(new Callable<Object>(){
            public Object call() throws Exception {
                ...
                settingsFrame.setXY(width / 4 - settingsFrame.getWidth() / 2,
                        height / 2 - settingsFrame.getHeight() / 2);
                ...
                checkInvertMouse.addSelectionChangedListener(new ISelectionChangedListener() {
                    public void selectionChanged(SelectionChangedEvent e) {
                        ControlManager.get().invertPitch();
                    }                
                });
                ...
                soundEnabled.addSelectionChangedListener(new ISelectionChangedListener() {
                    public void selectionChanged(SelectionChangedEvent e) {
                        SoundUtil.get().setEnableSoundFx(!SoundUtil.get().isEnableSoundFx());
                    }                
                });
                ...
                musicEnabled.addSelectionChangedListener(new ISelectionChangedListener() {
                    public void selectionChanged(SelectionChangedEvent e) {
                        SoundUtil.get().setEnableMusic(!SoundUtil.get().isEnableMusic());
                    }                
                });
